		...
		<div class="pb-center-column col-xs-12 col-sm-12 col-md-8">
			...
			<div class="product-boxinfo">
				...
				{if $PS_STOCK_MANAGEMENT}
					...
					<p class="label warning_inline" id="last_quantities"{if ($product->quantity > $last_qties || $product->quantity <= 0) || $allow_oosp || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none"{/if} >{l s='Warning: Last items in stock!'}</p>
				{/if}
