...
<div class="display hidden-xs pull-left">
	<div id="grid"><a rel="nofollow" href="#" title="{l s='Grid'}"><i class="fa fa-th"></i></a></div>
    <div id="list"><a rel="nofollow" href="#" title="{l s='List'}"><i class="fa fa-list-ul"></i></a></div>
</div>
...
<form id="productsSortForm{if isset($paginationId)}_{$paginationId}{/if}" action="{$request|escape:'html':'UTF-8'}" class="productsSortForm form-horizontal hidden-xs">
	<div class="select">
