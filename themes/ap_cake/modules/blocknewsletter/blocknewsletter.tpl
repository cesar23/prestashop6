...
<div id="newsletter_block_left" class="footer-block block inline">
	...
	<div class="block_content toggle-footer">
		<span class="info-newletter">{l s='Duis sed odio sit amet nibh vulputate rsus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris' mod='blocknewsletter'}</span>
		<form action="{$link->getPageLink('index', null, null, null, false, null, true)|escape:'html':'UTF-8'}" method="post">
			<div class="form-group{if isset($msg) && $msg } {if $nw_error}form-error{else}form-ok{/if}{/if}">
				...
				<button type="submit" name="submitNewsletter" class="btn button button-small">
                    <i class="fa fa-envelope"></i><span>{l s='Register' mod='blocknewsletter'}</span>
                </button>
