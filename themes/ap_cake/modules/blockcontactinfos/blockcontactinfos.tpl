...
<div id="block_contact_infos" class="block">
	<div>
        <h4 class="title_block">{l s='Main office' mod='blockcontactinfos'}</h4>
        <ul>
            {if $blockcontactinfos_company != ''}
            	<li>
            		{$blockcontactinfos_company|escape:'html':'UTF-8'}{if $blockcontactinfos_address != ''} <br>{$blockcontactinfos_address|escape:'html':'UTF-8'}{/if}
            	</li>
            {/if}
