        ...
        {foreach from=$mproducts item=products name=mypLoop}
            <div class="item {if $smarty.foreach.mypLoop.first}active{/if}">
                ...
                {foreach from=$products item=product name=products}
                    <li class="{if ($smarty.foreach.products.iteration -1 ) is div by 5}product-default{else}{/if} ajax_block_product product_block {$scolumn} col-sp-12 {if $smarty.foreach.products.first}first_item{elseif $smarty.foreach.products.last}last_item{/if}">
